...
> 📄 [기획서](추가자료/AI교수_기획.md) · [3주 개발계획](추가자료/AI교수_개발계획.md) · [발표자료](추가자료/AI교수_발표자료.md) · 기타 문서는 [`추가자료/`](추가자료/)
...
- **실제 슬라이드 그대로** — 학습 화면 왼쪽에 업로드한 PDF 슬라이드를 원본 그대로 표시.
- **슬라이드별 타이핑 설명** — 오른쪽에서 AI 교수가 현재 슬라이드를 실시간 스트리밍으로 설명.
...
```
AIprofessor/
├─ 추가자료/                                     # 기획·개발계획·발표자료·랩미팅 문서
├─ 수업자료/                                     # 올린 강의 PDF (lec0·lec1·lec2 …)
